...
map.getView().fit([3920245.639676, 3722964.905795, 3921212.650165, 3723770.614782], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Beit Bassa Road</h2>';
        return titleElement;
    })(),
